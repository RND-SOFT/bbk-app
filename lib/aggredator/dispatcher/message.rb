  ...
  class Dispatcher
    class Message
      ...
      def initialize(delivery_info, properties, body)
        raise Dispatcher::UndeliverableError, 'Properties must be a Hash' unless properties.respond_to? :to_h
      ...
      def validate!
        raise Dispatcher::UndeliverableError, 'There is no reply_to in message' if reply_to.blank?
